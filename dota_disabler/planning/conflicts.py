...
PRIORITY = {
    ...
    "persona default wearable hidden by reviewed slot policy": 87,
    "persona wearable hidden by reviewed slot policy": 87,
    "persona style hidden by reviewed slot policy": 87,
