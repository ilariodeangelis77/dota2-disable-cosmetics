...
class MappingTests(unittest.TestCase):
    ...
    def test_legion_commander_automaton_assembles_normal_wearables_and_effects(self):
        hero = "npc_dota_hero_legion_commander"
        normal_models = {
            "weapon": "models/heroes/legion_commander/weapon.vmdl",
            "back": "models/heroes/legion_commander/back.vmdl",
            "head": "models/heroes/legion_commander/head.vmdl",
            "shoulder": "models/heroes/legion_commander/shoulder.vmdl",
            "arms": "models/heroes/legion_commander/arms.vmdl",
        }
        persona_models = {
            "weapon_persona_1": "models/items/legion/carnival/weapon.vmdl",
            "back_persona_1": "models/items/legion/carnival/back.vmdl",
            "misc_persona_1": "models/items/legion/carnival/gears.vmdl",
        }
        persona_body = "models/items/legion/carnival/base.vmdl"
        effects = (
            (
                "particles/units/heroes/hero_legion_commander/duel_ring.vpcf",
                "particles/econ/items/legion/carnival/duel_ring.vpcf",
            ),
            (
                "particles/units/heroes/hero_legion_commander/odds.vpcf",
                "particles/units/heroes/hero_legion_commander/carnival_odds.vpcf",
            ),
            (
                "particles/units/heroes/hero_legion_commander/odds_arrows.vpcf",
                "particles/units/heroes/hero_legion_commander/carnival_odds_arrows.vpcf",
            ),
        )
        normal_defaults = tuple(
            item(
        ...
        plan = generator.build_plan(
            {},
            records,
            {hero: "models/heroes/legion_commander/legion_commander.vmdl"},
            [],
        )
        by_target = {mapping.target: mapping for mapping in plan.mappings}
        ...
        self.assertEqual(
            by_target[persona_models["misc_persona_1"]].source,
            normal_models["shoulder"],
        )
        for source, target in effects:
        ...
        self.assertEqual(len(plan.model_compositions), 1)
        composition = plan.model_compositions[0]
        self.assertEqual(composition.target, persona_models["misc_persona_1"])
        self.assertEqual(composition.primary_source, normal_models["shoulder"])
